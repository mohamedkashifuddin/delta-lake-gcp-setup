...
spark = SparkSession.builder \
    .appName("Create Silver Watermark Table") \
...
delta_path = "gs://delta-lake-payment-gateway-476820/metadata/silver_job_control"
table_name = "silver.job_control"

# 2. Silver Job Control Table DDL (No renaming needed)
JOB_CONTROL_DDL = """
(
...
print("Starting creation of Silver Job Control table (Watermark)...")
