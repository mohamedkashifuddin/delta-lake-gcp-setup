...
spark = SparkSession.builder \
    .appName("Create Gold Watermark Table") \
...
delta_path = "gs://delta-lake-payment-gateway-476820/metadata/gold_job_control"
table_name = "gold.job_control"

# Gold Job Control Table DDL
JOB_CONTROL_DDL = """
(
...
print("Starting creation of Gold Job Control table (Watermark)...")
