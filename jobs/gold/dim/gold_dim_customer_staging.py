...
spark = SparkSession.builder \
    .appName("Create Gold Customer Dimension Staging Table") \
...
delta_path = "gs://delta-lake-payment-gateway-476820/gold/dim_customer_staging"
table_name = "gold.dim_customer_staging"
