...
spark = SparkSession.builder \
    .appName("Create Gold Fact Transactions Staging Table") \
...
delta_path = "gs://delta-lake-payment-gateway-476820/gold/fact_transactions_staging"
table_name = "gold.fact_transactions_staging"

# Schema is identical to gold.fact_transactions
STAGING_DDL = """
(
    customer_key BIGINT,
    merchant_key BIGINT,
